...
// const img_model_main = document.querySelector("#img_model_main");
// const prev_btn_img_model = document.querySelector("#prev_btn_img_model");
// const next_btn_img_model = document.querySelector("#next_btn_img_model");

// let currentItem = 0;

// function showPerson() {
//   const item = img_api[currentItem];
//   img_model_main.src = item.img;
// }

// prev_btn_img_model.addEventListener("click", function () {
//   currentItem--;
//   if (currentItem < 0) {
//     currentItem = img_api.length - 1;
//   }
//   showPerson(currentItem);
// });

// next_btn_img_model.addEventListener("click", function () {
//   currentItem++;
//   if (currentItem > img_api.length - 1) currentItem = 0;
//   showPerson();
// });
...
//   });
// document
//   .querySelector("#show_view_review_model")
//   .addEventListener("click", () => {
//     showReviewModal();
//   });
